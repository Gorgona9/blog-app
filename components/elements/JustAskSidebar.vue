    ...
    <div>
        <dialog-box @rehide="rehide" dismiss-text="dismiss" :hide="hideDialog">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 class="text-xl font-medium leading-6 text-gray-900 dark:text-white" id="modal-title">Beep Beep</h3>
                <div class="mt-2">
                    ...
                    <ul class="space-y-2 hidden sm:block">
                        ...
                        <li>
                            <a href="#"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">How to ask a good Question?</span>
                            </a>
                        </li>
